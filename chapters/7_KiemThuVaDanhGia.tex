...
\begin{itemize}
    \item \textbf{Unit Testing:} Tập trung xác minh tính đúng đắn của các khối logic nghiệp vụ lõi tại tầng Dịch vụ (Service) và các bộ lắng nghe sự kiện (Event Listener). Quá trình này được thực hiện trong môi trường cô lập, tách biệt độc lập khỏi các phụ thuộc vào cơ sở hạ tầng bên ngoài.
...
\hspace*{\parindent}
Các tính năng mới đều được phát triển theo vòng lặp
...
\begin{figure}[H]
    ...
    \caption{Kết quả chạy toàn bộ bộ unit test}
...
\begin{itemize}
    \item \textbf{Tỷ lệ lỗi:} 0.00\%. Với 4500 mẫu, hệ thống không
          đánh rơi bất kỳ yêu cầu nào, khẳng định độ ổn định cao ở tải mục tiêu.
...
hoàn thành thực tế của hệ thống EVGo. Trong tổng số 8 nhóm yêu cầu, hệ thống
