...
\begin{itemize}
    ...
    \item \textbf{Triển khai hạ tầng thực tế (Deployment):} Thay vì chạy trên môi trường cục bộ (Localhost), hệ thống Server sẽ được triển khai lên hạ tầng điện toán đám mây (Cloud) sử dụng máy ảo (Virtual Machine) trên nền tảng Microsoft Azure. Điều này giúp hệ thống có thể truy cập được từ Internet và sẵn sàng cho việc kiểm thử diện rộng.
